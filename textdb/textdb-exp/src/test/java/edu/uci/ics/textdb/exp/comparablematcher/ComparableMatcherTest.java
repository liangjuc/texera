...
public class ComparableMatcherTest {
    ...
    public List<Tuple> getDoubleQueryResults(String attributeName, NumberMatchingType matchingType, double threshold)
    ...
    public List<Tuple> getIntegerQueryResults(String attributeName, NumberMatchingType matchingType, int threshold)
            throws TextDBException {
        // Perform the query
        ComparablePredicate comparablePredicate = new ComparablePredicate(attributeName, matchingType, threshold);
        ComparableMatcher comparableMatcher = new ComparableMatcher(comparablePredicate);
